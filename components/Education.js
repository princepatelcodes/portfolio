...
const milestones = [
    {
        ...
        description: `Passed 10th grade with 9.8 CGPA and CBSE Board.`
    },
    {
        id: 2,
        date: 'Feb, 2017',
        title: 'Completed 12th',
        description: `Passed 10th grade with 69% and BSEB State Board.`
    },
    {
        id: 3,
        date: 'July 30, 2020',
        title: 'Completed Graduation (BCA)',
        description:
        'Completed My Bachelors in Computer Application Degree with 77%.'
    },
    {
        id: 4,
        date: 'July 30, 2022',
...
const Card = ({ id, title, description, date }) => {
    ...
    return (
            <HStack
                flex={1}
                p={{ base: 3, sm: 6 }}
                bg={useColorModeValue('whatsapp.200', 'gray.800')}
                spacing={5}
                rounded="lg"
                alignItems="center"
                pos="relative"
